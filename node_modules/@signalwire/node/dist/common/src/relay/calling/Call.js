...
class Call {
    ...
    refer(params) {
        return __awaiter(this, void 0, void 0, function* () {
            const component = new components_1.Refer(this, params);
            this._addComponent(component);
            yield component._waitFor(relay_1.CallReferState.NoAnswer, relay_1.CallReferState.Busy, relay_1.CallReferState.Cancel, relay_1.CallReferState.Success, relay_1.CallReferState.Error);
            return new results_1.ReferResult(component);
        });
    }
    referAsync(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._addComponent(component);
            yield component.execute();
            return new actions_1.ReferAction(component);
        });
    }
    on(event, callback) {
    ...
    _referChange(params) {
        this._notifyComponents(relay_1.CallNotification.Refer, this.tag, params);
